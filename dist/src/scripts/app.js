var F=[{id:"book-1",asin:"B00ZUX90S4",title:"Designing Data-Intensive Applications",author:"Martin Kleppmann",highlightsCount:6,tags:["Software Architecture","Distributed Systems","Reliability"],status:"reading"},{id:"book-2",asin:"B01862ES3A",title:"The Daily Stoic",author:"Ryan Holiday",highlightsCount:6,tags:["Philosophy","Stoicism","Mindset"],status:"completed"},{id:"book-3",asin:"B07D23CFGR",title:"Atomic Habits",author:"James Clear",highlightsCount:5,tags:["Productivity","Habit Formation","Systems Thinking"],status:"completed"},{id:"book-4",asin:"B004J4XGN6",title:"Thinking, Fast and Slow",author:"Daniel Kahneman",highlightsCount:5,tags:["Psychology","Cognitive Biases","Decision Making"],status:"reading"},{id:"book-5",asin:"B001GSTOAM",title:"Clean Code",author:"Robert C. Martin",highlightsCount:4,tags:["Software Craftsmanship","Refactoring","Clean Code"],status:"completed"}],z=[{id:"hl-101",bookId:"book-1",bookTitle:"Designing Data-Intensive Applications",rawText:"Reliability means continuing to work correctly (performing the correct function at the desired level of performance) even in the face of adversity (hardware or software faults, and even human error).",location:120,color:"yellow",importance:"Essential",tags:["Reliability","Software Architecture"],sourceNote:"Core definition of software reliability.",interpretation:"A system is not truly reliable if it only works under ideal conditions."},{id:"hl-102",bookId:"book-1",bookTitle:"Designing Data-Intensive Applications",rawText:"Scalability is the term we use to describe a system's ability to cope with increased load.",location:245,color:"blue",importance:"High",tags:["Distributed Systems"]},{id:"hl-103",bookId:"book-1",bookTitle:"Designing Data-Intensive Applications",rawText:"Maintainability means many different people will work on the system over time, and they should all be able to work on it productively.",location:380,color:"pink",importance:"High",tags:["Clean Code","Software Architecture"]},{id:"hl-104",bookId:"book-1",bookTitle:"Designing Data-Intensive Applications",rawText:"Behind every fault-tolerant system is a set of carefully reasoned invariants.",location:512,color:"orange",importance:"Essential",tags:["Distributed Systems"]},{id:"hl-201",bookId:"book-2",bookTitle:"The Daily Stoic",rawText:"The chief task in life is simply this: to identify and separate matters so that I can say clearly to myself which are externals not under my control, and which have to do with the choices I actually control.",location:45,color:"yellow",importance:"Essential",tags:["Stoicism","Mindset"],sourceNote:"Epictetus' Dichotomy of Control.",interpretation:"Direct energy only towards intentional choices, never external outcomes."},{id:"hl-202",bookId:"book-2",bookTitle:"The Daily Stoic",rawText:"You have power over your mind - not outside events. Realize this, and you will find strength.",location:190,color:"yellow",importance:"High",tags:["Stoicism","Psychology"]},{id:"hl-203",bookId:"book-2",bookTitle:"The Daily Stoic",rawText:"Waste no more time arguing what a good person should be. Be one.",location:320,color:"pink",importance:"Essential",tags:["Philosophy"]},{id:"hl-301",bookId:"book-3",bookTitle:"Atomic Habits",rawText:"You do not rise to the level of your goals. You fall to the level of your systems.",location:110,color:"yellow",importance:"Essential",tags:["Systems Thinking","Habit Formation"],interpretation:"Focus on designing frictionless recurring routines rather than obsessing over end milestones."},{id:"hl-302",bookId:"book-3",bookTitle:"Atomic Habits",rawText:"Every action you take is a vote for the type of person you wish to become.",location:280,color:"orange",importance:"High",tags:["Habit Formation","Mindset"]},{id:"hl-303",bookId:"book-3",bookTitle:"Atomic Habits",rawText:"Make it obvious, make it attractive, make it easy, make it satisfying.",location:450,color:"blue",importance:"Essential",tags:["Productivity"]},{id:"hl-401",bookId:"book-4",bookTitle:"Thinking, Fast and Slow",rawText:"System 1 operates automatically and quickly, with little or no effort and no sense of voluntary control.",location:80,color:"yellow",importance:"High",tags:["Cognitive Biases","Psychology"]},{id:"hl-402",bookId:"book-4",bookTitle:"Thinking, Fast and Slow",rawText:"System 2 allocates attention to the effortful mental operations that demand it, including complex computations.",location:140,color:"blue",importance:"High",tags:["Cognitive Biases","Decision Making"]},{id:"hl-403",bookId:"book-4",bookTitle:"Thinking, Fast and Slow",rawText:"We are prone to overestimate how much we understand about the world and to underestimate the role of chance.",location:390,color:"pink",importance:"Essential",tags:["Decision Making","Mindset"]},{id:"hl-501",bookId:"book-5",bookTitle:"Clean Code",rawText:"Even bad code can function. But if code isn't clean, it can bring a development organization to its knees.",location:95,color:"yellow",importance:"Essential",tags:["Clean Code","Software Craftsmanship"]},{id:"hl-502",bookId:"book-5",bookTitle:"Clean Code",rawText:"Leave the campground cleaner than you found it. The Boy Scout Rule.",location:210,color:"pink",importance:"Essential",tags:["Refactoring","Clean Code"],sourceNote:"Apply incremental continuous cleanup to every PR."}];var T=class{static COLOR_PALETTE={book:"#818cf8",topic:"#38bdf8",author:"#c084fc",yellowHighlight:"#fcd34d",blueHighlight:"#67e8f9",pinkHighlight:"#fda4af",orangeHighlight:"#fdba74"};static buildGraph(e,i,t){let s=[],n=[],a=new Set,l=new Map;for(let o=0;o<e.length;o++){let r=e[o];if(s.push({id:r.id,label:r.title,type:"book",group:1,size:Math.max(16,Math.min(32,14+r.highlightsCount*2)),color:this.COLOR_PALETTE.book,bookTitle:r.title}),a.add(r.id),r.tags)for(let c of r.tags)l.set(c,(l.get(c)||0)+1)}for(let[o,r]of l.entries()){let c=`topic-${o.toLowerCase().replace(/\s+/g,"-")}`;s.push({id:c,label:`#${o}`,type:"topic",group:2,size:Math.max(12,Math.min(24,10+r*3)),color:this.COLOR_PALETTE.topic}),a.add(c);for(let d of e)d.tags?.includes(o)&&n.push({source:d.id,target:c,type:"shares_topic",strength:.7})}for(let o of i){if(t&&!t.has(o.id))continue;let r=this.COLOR_PALETTE.yellowHighlight;o.color==="blue"?r=this.COLOR_PALETTE.blueHighlight:o.color==="pink"?r=this.COLOR_PALETTE.pinkHighlight:o.color==="orange"&&(r=this.COLOR_PALETTE.orangeHighlight);let c=o.location!==void 0?`Loc ${o.location}`:"Note",d=o.rawText.substring(0,36)+(o.rawText.length>36?"...":"");if(s.push({id:o.id,label:`${c}: ${d}`,type:"highlight",group:3,size:o.importance==="Essential"?10:7,color:r,bookId:o.bookId,bookTitle:o.bookTitle,rawText:o.rawText,note:o.sourceNote,location:o.location,importance:o.importance}),a.add(o.id),a.has(o.bookId)&&n.push({source:o.bookId,target:o.id,type:"contains",strength:.9}),o.tags)for(let h of o.tags){let g=`topic-${h.toLowerCase().replace(/\s+/g,"-")}`;a.has(g)&&n.push({source:o.id,target:g,type:"shares_topic",strength:.4})}}return{nodes:s,links:n}}};var k=class p{static instance;listeners=new Set;state={books:F,highlights:z,filters:{searchQuery:"",selectedBookId:null,selectedColors:new Set(["yellow","blue","pink","orange"]),selectedImportance:new Set(["Essential","High","Medium","Low"]),selectedTopics:new Set},graphData:{nodes:[],links:[]},activeView:"graph",selectedHighlight:null,isLoading:!1,activeDataset:"demo"};constructor(){this.recomputeGraph()}static getInstance(){return p.instance||(p.instance=new p),p.instance}getState(){return this.state}subscribe(e){return this.listeners.add(e),e(this.state),()=>this.listeners.delete(e)}notify(){for(let e of this.listeners)e(this.state)}setView(e){this.state.activeView=e,this.notify()}selectHighlight(e){this.state.selectedHighlight=e,this.notify()}setSearchQuery(e){this.state.filters.searchQuery=e.toLowerCase().trim(),this.recomputeGraph(),this.notify()}selectBook(e){this.state.filters.selectedBookId=e,this.recomputeGraph(),this.notify()}toggleColorFilter(e){this.state.filters.selectedColors.has(e)?this.state.filters.selectedColors.delete(e):this.state.filters.selectedColors.add(e),this.recomputeGraph(),this.notify()}loadCustomData(e,i,t){this.state.books=e,this.state.highlights=i,this.state.activeDataset=t,this.state.filters.selectedBookId=null,this.state.filters.searchQuery="",this.recomputeGraph(),this.notify()}updateBookStatus(e,i){let t=this.state.books.find(s=>s.id===e);t&&(t.status=i,this.notify())}updateHighlightInterpretation(e,i){let t=this.state.highlights.find(s=>s.id===e);t&&(t.interpretation=i,this.notify())}loadDemoData(){this.state.books=F,this.state.highlights=z,this.state.activeDataset="demo",this.state.filters.selectedBookId=null,this.state.filters.searchQuery="",this.recomputeGraph(),this.notify()}getFilteredHighlights(){let{searchQuery:e,selectedBookId:i,selectedColors:t,selectedImportance:s}=this.state.filters;return this.state.highlights.filter(n=>{if(i&&n.bookId!==i||t.size>0&&!t.has(n.color)||n.importance&&s.size>0&&!s.has(n.importance))return!1;if(e){let a=n.rawText.toLowerCase().includes(e),l=n.bookTitle.toLowerCase().includes(e),o=n.sourceNote?.toLowerCase().includes(e),r=n.tags?.some(c=>c.toLowerCase().includes(e));if(!a&&!l&&!o&&!r)return!1}return!0})}recomputeGraph(){let e=this.getFilteredHighlights(),i=new Set(e.map(t=>t.id));this.state.graphData=T.buildGraph(this.state.books,this.state.highlights,i)}};function Y(p){if(!p)return"";let e={"&quot;":'"',"&amp;":"&","&apos;":"'","&lt;":"<","&gt;":">","&nbsp;":" ","&laquo;":"\xAB","&raquo;":"\xBB","&mdash;":"\u2014","&ndash;":"\u2013","&hellip;":"\u2026","&lsquo;":"'","&rsquo;":"'","&ldquo;":'"',"&rdquo;":'"',"&lsaquo;":"\u2039","&rsaquo;":"\u203A","&trade;":"\u2122","&copy;":"\xA9","&reg;":"\xAE","&bull;":"\u2022","&middot;":"\xB7","&prime;":"\u2032","&Prime;":"\u2033"};return p.replace(/&[a-zA-Z]+;/g,i=>e[i.toLowerCase()]??i).replace(/&#(\d+);/g,(i,t)=>{try{return String.fromCodePoint(parseInt(t,10))}catch{return i}}).replace(/&#x([a-fA-F0-9]+);/g,(i,t)=>{try{return String.fromCodePoint(parseInt(t,16))}catch{return i}})}function L(p){return p?Y(p).normalize("NFKC").replace(/[\u200B-\u200D\uFEFF\u00AD\u200E\u200F]/g,"").replace(/[\u2018\u2019]/g,"'").replace(/[\u201C\u201D]/g,'"').replace(/[\u2013\u2014]/g,"-").replace(/\s+/g," ").trim():""}function V(p){return p?L(p).replace(/\s*\((?:Kindle Edition|English Edition|Arabic Edition)\)/gi,"").trim():"Untitled"}function j(p){if(!p)return"Unknown Author";let e=L(p);if(e.includes(",")&&!e.includes(";")){let i=e.split(",").map(t=>t.trim());i.length===2&&i[0]&&i[1]&&(e=`${i[1]} ${i[0]}`)}return e}var C=class{static parseMyClippings(e){let i=e.split(/==========/),t=new Map,s=[];for(let n=0;n<i.length;n++){let a=i[n]?.trim();if(!a)continue;let l=a.split(/\r?\n/).map(E=>E.trim()).filter(Boolean);if(l.length<3)continue;let o=l[0],r=o.match(/\(([^)]+)\)$/),c=o,d="Unknown Author";r&&r[1]&&(d=r[1].trim(),c=o.substring(0,o.lastIndexOf("(")).trim());let h=V(c),g=j(d),f=`${h}:::${g}`,b=t.get(f);b||(b={id:`book-${t.size+1}`,title:h,author:g,highlightsCount:0,status:"reading"},t.set(f,b));let u=l[1],m,v=u.match(/Location\s+(\d+)/i)||u.match(/page\s+(\d+)/i);v&&v[1]&&(m=parseInt(v[1],10));let y="yellow";/yellow/i.test(u)?y="yellow":/blue/i.test(u)?y="blue":/pink/i.test(u)?y="pink":/orange/i.test(u)&&(y="orange");let S=l.slice(2).join(" ");S&&(b.highlightsCount++,s.push({id:`hl-import-${s.length+1}`,bookId:b.id,bookTitle:b.title,rawText:L(S),location:m,color:y,importance:"Medium",status:"Inbox"}))}return{books:Array.from(t.values()),highlights:s}}static parseJsonSnapshot(e){try{let i=JSON.parse(e);if(Array.isArray(i.books)&&Array.isArray(i.highlights))return{books:i.books,highlights:i.highlights};throw new Error("Invalid Hakim JSON snapshot structure.")}catch(i){throw new Error(`Failed to parse JSON file: ${i instanceof Error?i.message:"Invalid JSON"}`)}}};var H=class{canvas;ctx;container;nodes=[];links=[];nodeMap=new Map;alpha=1;alphaMin=5e-4;alphaDecay=.018;isSimulationRunning=!0;config={gravity:.04,repulsion:550,linkDistance:110,linkStrength:.15,damping:.85,nodeSizeMultiplier:1,showLabels:!0,showParticles:!0};scale=1;minScale=.15;maxScale=5;offsetX=0;offsetY=0;targetScale=null;targetOffsetX=null;targetOffsetY=null;isPanning=!1;panStartX=0;panStartY=0;hoveredNode=null;selectedNode=null;draggedNode=null;onNodeClickCallback;starfieldGrid=[];animationFrameId=null;hudElement=null;constructor(e,i){this.container=e,this.onNodeClickCallback=i,this.canvas=document.createElement("canvas"),this.canvas.className="graph-canvas",this.container.appendChild(this.canvas);let t=this.canvas.getContext("2d");if(!t)throw new Error("Could not get 2D context from canvas.");this.ctx=t,this.initStarfield(),this.resize(),this.initEvents(),this.createObsidianHUD()}initStarfield(){this.starfieldGrid=[];for(let e=0;e<120;e++)this.starfieldGrid.push({x:(Math.random()-.5)*4e3,y:(Math.random()-.5)*4e3,opacity:.15+Math.random()*.35,size:.8+Math.random()*1.5})}setData(e){let i=this.canvas.width/(window.devicePixelRatio||1),t=this.canvas.height/(window.devicePixelRatio||1);this.nodeMap.clear(),this.nodes=e.nodes.map((s,n)=>{let a=this.nodes.find(d=>d.id===s.id),l=n/Math.max(1,e.nodes.length)*2*Math.PI,o=s.type==="book"?140:s.type==="topic"?240:320+n%6*25,r=s.size||(s.type==="book"?24:s.type==="topic"?16:8),c={...s,x:a?a.x:i/2+Math.cos(l)*o+(Math.random()-.5)*50,y:a?a.y:t/2+Math.sin(l)*o+(Math.random()-.5)*50,vx:a?a.vx:(Math.random()-.5)*2,vy:a?a.vy:(Math.random()-.5)*2,radius:r};return this.nodeMap.set(s.id,c),c}),this.links=e.links.map(s=>({...s,sourceNode:this.nodeMap.get(typeof s.source=="string"?s.source:s.source.id),targetNode:this.nodeMap.get(typeof s.target=="string"?s.target:s.target.id)})),this.alpha=1,this.startSimulation()}resize(){let e=this.container.getBoundingClientRect(),i=window.devicePixelRatio||1,t=e.width||800,s=e.height||600;this.canvas.width=t*i,this.canvas.height=s*i,this.canvas.style.width=`${t}px`,this.canvas.style.height=`${s}px`,this.ctx.scale(i,i),this.offsetX===0&&this.offsetY===0&&(this.offsetX=t/2,this.offsetY=s/2)}startSimulation(){this.animationFrameId!==null&&cancelAnimationFrame(this.animationFrameId);let e=()=>{this.targetScale!==null&&this.targetOffsetX!==null&&this.targetOffsetY!==null&&(this.scale+=(this.targetScale-this.scale)*.12,this.offsetX+=(this.targetOffsetX-this.offsetX)*.12,this.offsetY+=(this.targetOffsetY-this.offsetY)*.12,Math.abs(this.scale-this.targetScale)<.005&&Math.abs(this.offsetX-this.targetOffsetX)<.5&&Math.abs(this.offsetY-this.targetOffsetY)<.5&&(this.scale=this.targetScale,this.offsetX=this.targetOffsetX,this.offsetY=this.targetOffsetY,this.targetScale=null,this.targetOffsetX=null,this.targetOffsetY=null)),this.isSimulationRunning&&this.tick(),this.render(),this.animationFrameId=requestAnimationFrame(e)};this.animationFrameId=requestAnimationFrame(e)}tick(){if(this.alpha<this.alphaMin)return;let e=this.canvas.width/(window.devicePixelRatio||1),i=this.canvas.height/(window.devicePixelRatio||1),t=e/2,s=i/2,n=this.config.gravity*this.alpha;for(let o of this.nodes)o.vx+=(t-o.x)*n,o.vy+=(s-o.y)*n;let a=this.config.repulsion*this.alpha;for(let o=0;o<this.nodes.length;o++){let r=this.nodes[o];for(let c=o+1;c<this.nodes.length;c++){let d=this.nodes[c],h=d.x-r.x,g=d.y-r.y,f=h*h+g*g;f===0&&(f=1);let b=Math.sqrt(f),u=(r.radius+d.radius)*this.config.nodeSizeMultiplier+20,m=r.type==="book"||d.type==="book"?3:1.2,v=a/f*m,y=h/b*v,S=g/b*v;if(r.isDragging||(r.vx-=y,r.vy-=S),d.isDragging||(d.vx+=y,d.vy+=S),b<u){let E=(u-b)*.6*this.alpha,U=h/b*E,G=g/b*E;r.isDragging||(r.x-=U,r.y-=G),d.isDragging||(d.x+=U,d.y+=G)}}}for(let o of this.links){if(!o.sourceNode||!o.targetNode)continue;let r=o.sourceNode,c=o.targetNode,d=c.x-r.x,h=c.y-r.y,g=Math.sqrt(d*d+h*h)||1,f=o.type==="contains"?this.config.linkDistance:this.config.linkDistance*1.6,b=(o.strength||.5)*this.config.linkStrength*this.alpha,u=(g-f)*b,m=d/g*u,v=h/g*u;r.isDragging||(r.vx+=m,r.vy+=v),c.isDragging||(c.vx-=m,c.vy-=v)}let l=this.config.damping;for(let o of this.nodes)o.isDragging||(o.vx*=l,o.vy*=l,o.x+=o.vx,o.y+=o.vy);this.alpha+=(0-this.alpha)*this.alphaDecay}render(){let e=this.canvas.width/(window.devicePixelRatio||1),i=this.canvas.height/(window.devicePixelRatio||1);if(this.ctx.fillStyle="#0a0d14",this.ctx.fillRect(0,0,e,i),this.ctx.save(),this.ctx.translate(this.offsetX,this.offsetY),this.ctx.scale(this.scale,this.scale),this.config.showParticles){this.ctx.fillStyle="rgba(255, 255, 255, 0.25)";for(let t of this.starfieldGrid)this.ctx.beginPath(),this.ctx.arc(t.x,t.y,t.size/this.scale,0,2*Math.PI),this.ctx.globalAlpha=t.opacity,this.ctx.fill();this.ctx.globalAlpha=1}for(let t of this.links){if(!t.sourceNode||!t.targetNode)continue;let s=this.hoveredNode&&(t.sourceNode.id===this.hoveredNode.id||t.targetNode.id===this.hoveredNode.id)||this.selectedNode&&(t.sourceNode.id===this.selectedNode.id||t.targetNode.id===this.selectedNode.id),n=(this.hoveredNode||this.selectedNode)&&!s;this.ctx.beginPath(),this.ctx.moveTo(t.sourceNode.x-e/2,t.sourceNode.y-i/2),this.ctx.lineTo(t.targetNode.x-e/2,t.targetNode.y-i/2),s?(this.ctx.strokeStyle="rgba(168, 85, 247, 0.9)",this.ctx.lineWidth=2.2/Math.sqrt(this.scale),this.ctx.shadowColor="rgba(168, 85, 247, 0.8)",this.ctx.shadowBlur=8):(this.ctx.shadowBlur=0,this.ctx.strokeStyle=n?"rgba(255, 255, 255, 0.02)":t.type==="shares_topic"?"rgba(56, 189, 248, 0.22)":"rgba(255, 255, 255, 0.08)",this.ctx.lineWidth=(t.type==="contains"?1.2:.8)/Math.sqrt(this.scale)),this.ctx.stroke(),this.ctx.shadowBlur=0}for(let t of this.nodes){let s=t.x-e/2,n=t.y-i/2,a=t.radius*this.config.nodeSizeMultiplier,l=this.hoveredNode?.id===t.id,o=this.selectedNode?.id===t.id,r=this.hoveredNode&&this.areNodesConnected(t,this.hoveredNode)||this.selectedNode&&this.areNodesConnected(t,this.selectedNode),c=(this.hoveredNode||this.selectedNode)&&!l&&!o&&!r;if(this.ctx.save(),this.ctx.globalAlpha=c?.12:1,t.type==="book"||t.type==="topic"||l||o){let h=a+(t.type==="book"?10:6),g=this.ctx.createRadialGradient(s,n,a*.6,s,n,h),f=t.type==="book"?"rgba(168, 85, 247, 0.35)":t.type==="topic"?"rgba(56, 189, 248, 0.35)":"rgba(255, 255, 255, 0.3)";g.addColorStop(0,f),g.addColorStop(1,"rgba(0, 0, 0, 0)"),this.ctx.beginPath(),this.ctx.arc(s,n,h,0,2*Math.PI),this.ctx.fillStyle=g,this.ctx.fill()}if((t.type==="book"||o)&&(this.ctx.beginPath(),this.ctx.arc(s,n,a+4,0,2*Math.PI),this.ctx.strokeStyle=o?"#38bdf8":"rgba(168, 85, 247, 0.6)",this.ctx.lineWidth=1.8/Math.sqrt(this.scale),this.ctx.stroke()),this.ctx.beginPath(),this.ctx.arc(s,n,a,0,2*Math.PI),this.ctx.fillStyle=t.color,this.ctx.fill(),this.ctx.strokeStyle=l||o?"#ffffff":"rgba(255, 255, 255, 0.35)",this.ctx.lineWidth=(l?2.5:1.2)/Math.sqrt(this.scale),this.ctx.stroke(),this.config.showLabels&&(t.type==="book"||t.type==="topic"||l||o||r||this.scale>.85)){let h=t.type==="book"?13:t.type==="topic"?11.5:10;this.ctx.font=`${t.type==="book"?"700":"600"} ${h/Math.sqrt(this.scale)}px Inter, sans-serif`,this.ctx.textAlign="center",this.ctx.textBaseline="top";let g=t.label;t.type==="highlight"&&g.length>24&&(g=g.substring(0,22)+"...");let f=n+a+4/Math.sqrt(this.scale);this.ctx.fillStyle="rgba(10, 13, 20, 0.75)";let b=this.ctx.measureText(g),u=4/Math.sqrt(this.scale),m=2/Math.sqrt(this.scale),v=h/Math.sqrt(this.scale);this.ctx.fillRect(s-b.width/2-u,f-m,b.width+u*2,v+m*2),this.ctx.fillStyle=l||o?"#ffffff":t.type==="book"?"#f1f5f9":"rgba(255, 255, 255, 0.85)",this.ctx.fillText(g,s,f)}this.ctx.restore()}this.ctx.restore()}areNodesConnected(e,i){return this.links.some(t=>t.sourceNode?.id===e.id&&t.targetNode?.id===i.id||t.sourceNode?.id===i.id&&t.targetNode?.id===e.id)}getNodeAtPosition(e,i){let t=this.canvas.width/(window.devicePixelRatio||1),s=this.canvas.height/(window.devicePixelRatio||1),n=(e-this.offsetX)/this.scale+t/2,a=(i-this.offsetY)/this.scale+s/2;for(let l=this.nodes.length-1;l>=0;l--){let o=this.nodes[l],r=n-o.x,c=a-o.y,d=o.radius*this.config.nodeSizeMultiplier+6;if(r*r+c*c<=d*d)return o}return null}flyToNode(e,i=1.8){let t=this.canvas.width/(window.devicePixelRatio||1),s=this.canvas.height/(window.devicePixelRatio||1);this.targetScale=i,this.targetOffsetX=t/2-(e.x-t/2)*i,this.targetOffsetY=s/2-(e.y-s/2)*i,this.selectedNode=e}createObsidianHUD(){this.hudElement=document.createElement("div"),this.hudElement.className="obsidian-graph-hud",this.hudElement.innerHTML=`
    ...
    `,this.container.appendChild(this.hudElement);let e=this.hudElement.querySelector("#btn-toggle-hud"),i=this.hudElement.querySelector(".hud-body");e?.addEventListener("click",()=>{i&&(i.style.display=i.style.display==="none"?"flex":"none",e.textContent=i.style.display==="none"?"+":"\u2014")});let t=this.hudElement.querySelector("#slider-repulsion");t?.addEventListener("input",()=>{this.config.repulsion=Number(t.value);let r=this.hudElement?.querySelector("#val-repulsion");r&&(r.textContent=t.value),this.alpha=Math.max(this.alpha,.4)});let s=this.hudElement.querySelector("#slider-distance");s?.addEventListener("input",()=>{this.config.linkDistance=Number(s.value);let r=this.hudElement?.querySelector("#val-distance");r&&(r.textContent=s.value),this.alpha=Math.max(this.alpha,.4)});let n=this.hudElement.querySelector("#slider-gravity");n?.addEventListener("input",()=>{this.config.gravity=Number(n.value)/100;let r=this.hudElement?.querySelector("#val-gravity");r&&(r.textContent=n.value),this.alpha=Math.max(this.alpha,.4)});let a=this.hudElement.querySelector("#chk-labels");a?.addEventListener("change",()=>{this.config.showLabels=a.checked});let l=this.hudElement.querySelector("#chk-particles");l?.addEventListener("change",()=>{this.config.showParticles=l.checked}),this.hudElement.querySelector("#btn-reset-camera")?.addEventListener("click",()=>this.resetView());let o=this.hudElement.querySelector("#btn-toggle-sim");o?.addEventListener("click",()=>{let r=this.togglePhysics();o&&(o.textContent=r?"Freeze":"Unfreeze")})}initEvents(){window.addEventListener("resize",()=>this.resize()),this.canvas.addEventListener("mousemove",e=>{let i=this.canvas.getBoundingClientRect(),t=e.clientX-i.left,s=e.clientY-i.top;if(this.draggedNode){let a=this.canvas.width/(window.devicePixelRatio||1),l=this.canvas.height/(window.devicePixelRatio||1);this.draggedNode.x=(t-this.offsetX)/this.scale+a/2,this.draggedNode.y=(s-this.offsetY)/this.scale+l/2,this.alpha=Math.max(this.alpha,.4);return}if(this.isPanning){this.offsetX+=t-this.panStartX,this.offsetY+=s-this.panStartY,this.panStartX=t,this.panStartY=s;return}let n=this.getNodeAtPosition(t,s);this.hoveredNode=n,this.canvas.style.cursor=n?"pointer":"grab"}),this.canvas.addEventListener("mousedown",e=>{let i=this.canvas.getBoundingClientRect(),t=e.clientX-i.left,s=e.clientY-i.top,n=this.getNodeAtPosition(t,s);n?(this.draggedNode=n,n.isDragging=!0,this.alpha=.6):(this.isPanning=!0,this.panStartX=t,this.panStartY=s,this.canvas.style.cursor="grabbing")}),window.addEventListener("mouseup",e=>{this.draggedNode&&(this.draggedNode.isDragging=!1,this.draggedNode=null),this.isPanning=!1,this.canvas.style.cursor=this.hoveredNode?"pointer":"grab"}),this.canvas.addEventListener("click",e=>{let i=this.canvas.getBoundingClientRect(),t=e.clientX-i.left,s=e.clientY-i.top,n=this.getNodeAtPosition(t,s);n?(this.flyToNode(n),this.onNodeClickCallback&&this.onNodeClickCallback(n)):this.selectedNode=null}),this.canvas.addEventListener("wheel",e=>{e.preventDefault();let i=this.canvas.getBoundingClientRect(),t=e.clientX-i.left,s=e.clientY-i.top,n=e.deltaY<0?1.14:.86,a=Math.max(this.minScale,Math.min(this.maxScale,this.scale*n));this.offsetX=t-(t-this.offsetX)*(a/this.scale),this.offsetY=s-(s-this.offsetY)*(a/this.scale),this.scale=a},{passive:!1})}zoomIn(){this.scale=Math.min(this.maxScale,this.scale*1.25)}zoomOut(){this.scale=Math.max(this.minScale,this.scale*.8)}resetView(){let e=this.container.getBoundingClientRect();this.scale=1,this.targetScale=null,this.targetOffsetX=null,this.targetOffsetY=null,this.offsetX=(e.width||800)/2,this.offsetY=(e.height||600)/2,this.selectedNode=null,this.alpha=1}togglePhysics(){return this.isSimulationRunning=!this.isSimulationRunning,this.isSimulationRunning&&(this.alpha=.5),this.isSimulationRunning}};var I=class{container;currentTab="highlights";onSelectHighlight;onSelectBook;onUpdateBookStatus;onOpenQuoteCard;constructor(e,i){this.container=e,this.onSelectHighlight=i?.onSelectHighlight,this.onSelectBook=i?.onSelectBook,this.onUpdateBookStatus=i?.onUpdateBookStatus,this.onOpenQuoteCard=i?.onOpenQuoteCard}render(e,i){this.container.innerHTML="";let t=document.createElement("div");t.className="cards-nav-header";let s=document.createElement("div");s.className="cards-subtabs",[{id:"highlights",label:`Highlights (${i.length})`,icon:"\u{1F4AC}"},{id:"books",label:`Book Shelf (${e.length})`,icon:"\u{1F4DA}"},{id:"kanban",label:"Reading OS Kanban",icon:"\u{1F4CA}"}].forEach(l=>{let o=document.createElement("button");o.className=`subtab-btn ${this.currentTab===l.id?"active":""}`,o.setAttribute("data-subtab",l.id),o.innerHTML=`<span>${l.icon}</span> <span>${l.label}</span>`,o.addEventListener("click",()=>{this.currentTab=l.id,this.render(e,i)}),s.appendChild(o)}),t.appendChild(s),this.container.appendChild(t);let a=document.createElement("div");a.className="cards-content-body",this.currentTab==="highlights"?a.appendChild(this.createHighlightsGrid(i)):this.currentTab==="books"?a.appendChild(this.createBooksGrid(e)):this.currentTab==="kanban"&&a.appendChild(this.createKanbanBoard(e)),this.container.appendChild(a)}createHighlightsGrid(e){let i=document.createElement("div");if(i.className="highlights-masonry-grid",e.length===0){let t=document.createElement("div");return t.className="empty-state-editorial",t.innerHTML=`
      ...
      `;let a=s.querySelector(".btn-copy-quote");a?.addEventListener("click",o=>{o.stopPropagation();let r=`> "${t.rawText}"
> \u2014 **${t.bookTitle}** (Loc ${t.location||"N/A"})`;navigator.clipboard?.writeText(r),a.innerHTML='<span style="color:#10b981;font-size:11px;font-weight:700;">\u2713</span>',setTimeout(()=>{a.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>'},1500)}),s.querySelector(".btn-artboard-quote")?.addEventListener("click",o=>{o.stopPropagation(),this.onOpenQuoteCard?this.onOpenQuoteCard(t):this.onSelectHighlight&&this.onSelectHighlight(t)}),s.addEventListener("click",()=>{this.onSelectHighlight&&this.onSelectHighlight(t)}),i.appendChild(s)}),i}createBooksGrid(e){let i=document.createElement("div");return i.className="books-shelf-grid",e.forEach(t=>{let s=document.createElement("article");s.className="book-shelf-card",s.innerHTML=`
      ...
      `,s.addEventListener("click",()=>{this.onSelectBook&&this.onSelectBook(t.id)}),i.appendChild(s)}),i}createKanbanBoard(e){let i=document.createElement("div");return i.className="kanban-board-container",[{id:"reading",title:"Currently Reading",emoji:"\u{1F4D6}"},{id:"completed",title:"Completed & Processed",emoji:"\u2705"},{id:"want_to_read",title:"Want to Read",emoji:"\u{1F516}"}].forEach(s=>{let n=e.filter(r=>(r.status||"reading")===s.id),a=document.createElement("div");a.className="kanban-column";let l=document.createElement("div");l.className="kanban-col-header",l.innerHTML=`
        <span class="kanban-col-title">${s.emoji} ${s.title}</span>
        <span class="kanban-col-count">${n.length}</span>
      `,a.appendChild(l);let o=document.createElement("div");o.className="kanban-cards-stack",o.setAttribute("data-status",s.id),n.forEach(r=>{let c=document.createElement("div");c.className="kanban-book-item",c.innerHTML=`
    ...
    `,this.panel.querySelector("#btn-close-slideover")?.addEventListener("click",()=>this.close()),this.panel.querySelector("#btn-open-quote-card")?.addEventListener("click",()=>{this.currentHighlight&&this.quoteModal.open(this.currentHighlight)});let t="obsidian",s=this.panel.querySelector("#citation-text-content"),n=this.panel.querySelectorAll(".btn-cite-format");n.forEach(c=>{c.addEventListener("click",()=>{n.forEach(d=>d.classList.remove("active")),c.classList.add("active"),t=c.getAttribute("data-fmt")||"obsidian",s&&(s.textContent=this.generateCitation(e,t))})});let a=this.panel.querySelector("#btn-copy-active-citation");a?.addEventListener("click",async()=>{let c=s?.textContent||"";navigator.clipboard&&(await navigator.clipboard.writeText(c),a&&(a.textContent="Copied!",a.style.color="#10b981",setTimeout(()=>{a.textContent="Copy",a.style.color=""},1800)))});let l=this.panel.querySelector("#drawer-reflection-input"),o=this.panel.querySelector("#save-status-indicator"),r=null;l?.addEventListener("input",()=>{o&&(o.textContent="Saving..."),clearTimeout(r),r=setTimeout(()=>{this.currentHighlight&&(this.currentHighlight.interpretation=l.value,this.store.updateHighlightInterpretation(this.currentHighlight.id,l.value),o&&(o.textContent="Saved"))},500)})}generateCitation(e,i){let t=e.location?`Loc ${e.location}`:"Personal Note";switch(i){case"obsidian":return`> "${e.rawText}"
