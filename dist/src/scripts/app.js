var z=[{id:"book-1",asin:"B00ZUX90S4",title:"Designing Data-Intensive Applications",author:"Martin Kleppmann",highlightsCount:6,tags:["Software Architecture","Distributed Systems","Reliability"],status:"reading"},{id:"book-2",asin:"B01862ES3A",title:"The Daily Stoic",author:"Ryan Holiday",highlightsCount:6,tags:["Philosophy","Stoicism","Mindset"],status:"completed"},{id:"book-3",asin:"B07D23CFGR",title:"Atomic Habits",author:"James Clear",highlightsCount:5,tags:["Productivity","Habit Formation","Systems Thinking"],status:"completed"},{id:"book-4",asin:"B004J4XGN6",title:"Thinking, Fast and Slow",author:"Daniel Kahneman",highlightsCount:5,tags:["Psychology","Cognitive Biases","Decision Making"],status:"reading"},{id:"book-5",asin:"B001GSTOAM",title:"Clean Code",author:"Robert C. Martin",highlightsCount:4,tags:["Software Craftsmanship","Refactoring","Clean Code"],status:"completed"}],U=[{id:"hl-101",bookId:"book-1",bookTitle:"Designing Data-Intensive Applications",rawText:"Reliability means continuing to work correctly (performing the correct function at the desired level of performance) even in the face of adversity (hardware or software faults, and even human error).",location:120,color:"yellow",importance:"Essential",tags:["Reliability","Software Architecture"],sourceNote:"Core definition of software reliability.",interpretation:"A system is not truly reliable if it only works under ideal conditions."},{id:"hl-102",bookId:"book-1",bookTitle:"Designing Data-Intensive Applications",rawText:"Scalability is the term we use to describe a system's ability to cope with increased load.",location:245,color:"blue",importance:"High",tags:["Distributed Systems"]},{id:"hl-103",bookId:"book-1",bookTitle:"Designing Data-Intensive Applications",rawText:"Maintainability means many different people will work on the system over time, and they should all be able to work on it productively.",location:380,color:"pink",importance:"High",tags:["Clean Code","Software Architecture"]},{id:"hl-104",bookId:"book-1",bookTitle:"Designing Data-Intensive Applications",rawText:"Behind every fault-tolerant system is a set of carefully reasoned invariants.",location:512,color:"orange",importance:"Essential",tags:["Distributed Systems"]},{id:"hl-201",bookId:"book-2",bookTitle:"The Daily Stoic",rawText:"The chief task in life is simply this: to identify and separate matters so that I can say clearly to myself which are externals not under my control, and which have to do with the choices I actually control.",location:45,color:"yellow",importance:"Essential",tags:["Stoicism","Mindset"],sourceNote:"Epictetus' Dichotomy of Control.",interpretation:"Direct energy only towards intentional choices, never external outcomes."},{id:"hl-202",bookId:"book-2",bookTitle:"The Daily Stoic",rawText:"You have power over your mind - not outside events. Realize this, and you will find strength.",location:190,color:"yellow",importance:"High",tags:["Stoicism","Psychology"]},{id:"hl-203",bookId:"book-2",bookTitle:"The Daily Stoic",rawText:"Waste no more time arguing what a good person should be. Be one.",location:320,color:"pink",importance:"Essential",tags:["Philosophy"]},{id:"hl-301",bookId:"book-3",bookTitle:"Atomic Habits",rawText:"You do not rise to the level of your goals. You fall to the level of your systems.",location:110,color:"yellow",importance:"Essential",tags:["Systems Thinking","Habit Formation"],interpretation:"Focus on designing frictionless recurring routines rather than obsessing over end milestones."},{id:"hl-302",bookId:"book-3",bookTitle:"Atomic Habits",rawText:"Every action you take is a vote for the type of person you wish to become.",location:280,color:"orange",importance:"High",tags:["Habit Formation","Mindset"]},{id:"hl-303",bookId:"book-3",bookTitle:"Atomic Habits",rawText:"Make it obvious, make it attractive, make it easy, make it satisfying.",location:450,color:"blue",importance:"Essential",tags:["Productivity"]},{id:"hl-401",bookId:"book-4",bookTitle:"Thinking, Fast and Slow",rawText:"System 1 operates automatically and quickly, with little or no effort and no sense of voluntary control.",location:80,color:"yellow",importance:"High",tags:["Cognitive Biases","Psychology"]},{id:"hl-402",bookId:"book-4",bookTitle:"Thinking, Fast and Slow",rawText:"System 2 allocates attention to the effortful mental operations that demand it, including complex computations.",location:140,color:"blue",importance:"High",tags:["Cognitive Biases","Decision Making"]},{id:"hl-403",bookId:"book-4",bookTitle:"Thinking, Fast and Slow",rawText:"We are prone to overestimate how much we understand about the world and to underestimate the role of chance.",location:390,color:"pink",importance:"Essential",tags:["Decision Making","Mindset"]},{id:"hl-501",bookId:"book-5",bookTitle:"Clean Code",rawText:"Even bad code can function. But if code isn't clean, it can bring a development organization to its knees.",location:95,color:"yellow",importance:"Essential",tags:["Clean Code","Software Craftsmanship"]},{id:"hl-502",bookId:"book-5",bookTitle:"Clean Code",rawText:"Leave the campground cleaner than you found it. The Boy Scout Rule.",location:210,color:"pink",importance:"Essential",tags:["Refactoring","Clean Code"],sourceNote:"Apply incremental continuous cleanup to every PR."}];var L=class{static COLOR_PALETTE={book:"#818cf8",topic:"#38bdf8",author:"#c084fc",yellowHighlight:"#fcd34d",blueHighlight:"#67e8f9",pinkHighlight:"#fda4af",orangeHighlight:"#fdba74"};static buildGraph(e,i,t){let s=[],n=[],a=new Set,r=new Map;for(let o=0;o<e.length;o++){let l=e[o];if(s.push({id:l.id,label:l.title,type:"book",group:1,size:Math.max(16,Math.min(32,14+l.highlightsCount*2)),color:this.COLOR_PALETTE.book,bookTitle:l.title}),a.add(l.id),l.tags)for(let c of l.tags)r.set(c,(r.get(c)||0)+1)}for(let[o,l]of r.entries()){let c=`topic-${o.toLowerCase().replace(/\s+/g,"-")}`;s.push({id:c,label:`#${o}`,type:"topic",group:2,size:Math.max(12,Math.min(24,10+l*3)),color:this.COLOR_PALETTE.topic}),a.add(c);for(let d of e)d.tags?.includes(o)&&n.push({source:d.id,target:c,type:"shares_topic",strength:.7})}for(let o of i){if(t&&!t.has(o.id))continue;let l=this.COLOR_PALETTE.yellowHighlight;o.color==="blue"?l=this.COLOR_PALETTE.blueHighlight:o.color==="pink"?l=this.COLOR_PALETTE.pinkHighlight:o.color==="orange"&&(l=this.COLOR_PALETTE.orangeHighlight);let c=o.location!==void 0?`Loc ${o.location}`:"Note",d=o.rawText.substring(0,36)+(o.rawText.length>36?"...":"");if(s.push({id:o.id,label:`${c}: ${d}`,type:"highlight",group:3,size:o.importance==="Essential"?10:7,color:l,bookId:o.bookId,bookTitle:o.bookTitle,rawText:o.rawText,note:o.sourceNote,location:o.location,importance:o.importance}),a.add(o.id),a.has(o.bookId)&&n.push({source:o.bookId,target:o.id,type:"contains",strength:.9}),o.tags)for(let h of o.tags){let m=`topic-${h.toLowerCase().replace(/\s+/g,"-")}`;a.has(m)&&n.push({source:o.id,target:m,type:"shares_topic",strength:.4})}}return{nodes:s,links:n}}};var k=class u{static instance;listeners=new Set;state={books:z,highlights:U,filters:{searchQuery:"",selectedBookId:null,selectedColors:new Set(["yellow","blue","pink","orange"]),selectedImportance:new Set(["Essential","High","Medium","Low"]),selectedTopics:new Set},graphData:{nodes:[],links:[]},activeView:"graph",selectedHighlight:null,isLoading:!1,activeDataset:"demo"};constructor(){this.recomputeGraph()}static getInstance(){return u.instance||(u.instance=new u),u.instance}getState(){return this.state}subscribe(e){return this.listeners.add(e),e(this.state),()=>this.listeners.delete(e)}notify(){for(let e of this.listeners)e(this.state)}setView(e){this.state.activeView=e,this.notify()}selectHighlight(e){this.state.selectedHighlight=e,this.notify()}setSearchQuery(e){this.state.filters.searchQuery=e.toLowerCase().trim(),this.recomputeGraph(),this.notify()}selectBook(e){this.state.filters.selectedBookId=e,this.recomputeGraph(),this.notify()}toggleColorFilter(e){this.state.filters.selectedColors.has(e)?this.state.filters.selectedColors.delete(e):this.state.filters.selectedColors.add(e),this.recomputeGraph(),this.notify()}loadCustomData(e,i,t){this.state.books=e,this.state.highlights=i,this.state.activeDataset=t,this.state.filters.selectedBookId=null,this.state.filters.searchQuery="",this.recomputeGraph(),this.notify()}updateBookStatus(e,i){let t=this.state.books.find(s=>s.id===e);t&&(t.status=i,this.notify())}updateHighlightInterpretation(e,i){let t=this.state.highlights.find(s=>s.id===e);t&&(t.interpretation=i,this.notify())}loadDemoData(){this.state.books=z,this.state.highlights=U,this.state.activeDataset="demo",this.state.filters.selectedBookId=null,this.state.filters.searchQuery="",this.recomputeGraph(),this.notify()}getFilteredHighlights(){let{searchQuery:e,selectedBookId:i,selectedColors:t,selectedImportance:s}=this.state.filters;return this.state.highlights.filter(n=>{if(i&&n.bookId!==i||t.size>0&&!t.has(n.color)||n.importance&&s.size>0&&!s.has(n.importance))return!1;if(e){let a=n.rawText.toLowerCase().includes(e),r=n.bookTitle.toLowerCase().includes(e),o=n.sourceNote?.toLowerCase().includes(e),l=n.tags?.some(c=>c.toLowerCase().includes(e));if(!a&&!r&&!o&&!l)return!1}return!0})}recomputeGraph(){let e=this.getFilteredHighlights(),i=new Set(e.map(t=>t.id));this.state.graphData=L.buildGraph(this.state.books,this.state.highlights,i)}};function X(u){if(!u)return"";let e={"&quot;":'"',"&amp;":"&","&apos;":"'","&lt;":"<","&gt;":">","&nbsp;":" ","&laquo;":"\xAB","&raquo;":"\xBB","&mdash;":"\u2014","&ndash;":"\u2013","&hellip;":"\u2026","&lsquo;":"'","&rsquo;":"'","&ldquo;":'"',"&rdquo;":'"',"&lsaquo;":"\u2039","&rsaquo;":"\u203A","&trade;":"\u2122","&copy;":"\xA9","&reg;":"\xAE","&bull;":"\u2022","&middot;":"\xB7","&prime;":"\u2032","&Prime;":"\u2033"};return u.replace(/&[a-zA-Z]+;/g,i=>e[i.toLowerCase()]??i).replace(/&#(\d+);/g,(i,t)=>{try{return String.fromCodePoint(parseInt(t,10))}catch{return i}}).replace(/&#x([a-fA-F0-9]+);/g,(i,t)=>{try{return String.fromCodePoint(parseInt(t,16))}catch{return i}})}function H(u){return u?X(u).normalize("NFKC").replace(/[\u200B-\u200D\uFEFF\u00AD\u200E\u200F]/g,"").replace(/[\u2018\u2019]/g,"'").replace(/[\u201C\u201D]/g,'"').replace(/[\u2013\u2014]/g,"-").replace(/\s+/g," ").trim():""}function Y(u){return u?H(u).replace(/\s*\((?:Kindle Edition|English Edition|Arabic Edition)\)/gi,"").trim():"Untitled"}function V(u){if(!u)return"Unknown Author";let e=H(u);if(e.includes(",")&&!e.includes(";")){let i=e.split(",").map(t=>t.trim());i.length===2&&i[0]&&i[1]&&(e=`${i[1]} ${i[0]}`)}return e}var T=class{static parseMyClippings(e){let i=e.split(/==========/),t=new Map,s=[];for(let n=0;n<i.length;n++){let a=i[n]?.trim();if(!a)continue;let r=a.split(/\r?\n/).map(S=>S.trim()).filter(Boolean);if(r.length<3)continue;let o=r[0],l=o.match(/\(([^)]+)\)$/),c=o,d="Unknown Author";l&&l[1]&&(d=l[1].trim(),c=o.substring(0,o.lastIndexOf("(")).trim());let h=Y(c),m=V(d),g=`${h}:::${m}`,b=t.get(g);b||(b={id:`book-${t.size+1}`,title:h,author:m,highlightsCount:0,status:"reading"},t.set(g,b));let p=r[1],f,v=p.match(/Location\s+(\d+)/i)||p.match(/page\s+(\d+)/i);v&&v[1]&&(f=parseInt(v[1],10));let y="yellow";/yellow/i.test(p)?y="yellow":/blue/i.test(p)?y="blue":/pink/i.test(p)?y="pink":/orange/i.test(p)&&(y="orange");let w=r.slice(2).join(" ");w&&(b.highlightsCount++,s.push({id:`hl-import-${s.length+1}`,bookId:b.id,bookTitle:b.title,rawText:H(w),location:f,color:y,importance:"Medium",status:"Inbox"}))}return{books:Array.from(t.values()),highlights:s}}static parseJsonSnapshot(e){try{let i=JSON.parse(e);if(Array.isArray(i.books)&&Array.isArray(i.highlights))return{books:i.books,highlights:i.highlights};throw new Error("Invalid Hakim JSON snapshot structure.")}catch(i){throw new Error(`Failed to parse JSON file: ${i instanceof Error?i.message:"Invalid JSON"}`)}}};var I=class{container;canvas;ctx;nodes=[];links=[];nodeMap=new Map;alpha=1;alphaMin=5e-4;alphaDecay=.015;isSimulationRunning=!0;config={gravity:.008,repulsion:1400,linkDistance:160,linkStrength:.12,damping:.88,nodeSizeMultiplier:1,showLabels:!0,showParticles:!0};scale=1;minScale=.15;maxScale=5;offsetX=0;offsetY=0;targetScale=null;targetOffsetX=null;targetOffsetY=null;isPanning=!1;panStartX=0;panStartY=0;hoveredNode=null;selectedNode=null;draggedNode=null;onNodeClickCallback;starfieldGrid=[];animationFrameId=null;hudElement=null;constructor(e,i){this.container=e,this.onNodeClickCallback=i,this.canvas=document.createElement("canvas"),this.canvas.className="graph-canvas",this.container.appendChild(this.canvas);let t=this.canvas.getContext("2d");if(!t)throw new Error("Could not get 2D context from canvas.");this.ctx=t,this.initStarfield(),this.resize(),this.initEvents(),this.createObsidianHUD()}initStarfield(){this.starfieldGrid=[];for(let e=0;e<140;e++)this.starfieldGrid.push({x:(Math.random()-.5)*4e3,y:(Math.random()-.5)*4e3,opacity:.15+Math.random()*.35,size:.8+Math.random()*1.5})}setData(e){let i=this.canvas.width/(window.devicePixelRatio||1),t=this.canvas.height/(window.devicePixelRatio||1);this.nodeMap.clear();let s=e.nodes.filter(r=>r.type==="book"),n=e.nodes.filter(r=>r.type!=="book"),a=new Map;s.forEach((r,o)=>{let l=o/Math.max(1,s.length)*2*Math.PI-Math.PI/2,c=340+o%2*50;a.set(r.id,{x:i/2+Math.cos(l)*c,y:t/2+Math.sin(l)*c})}),this.nodes=e.nodes.map((r,o)=>{let l=this.nodes.find(g=>g.id===r.id),c=r.size||(r.type==="book"?26:r.type==="topic"?16:8),d=i/2,h=t/2;if(l)d=l.x,h=l.y;else if(r.type==="book"){let g=a.get(r.id)||{x:i/2,y:t/2};d=g.x,h=g.y}else if(r.type==="topic"){let g=o/Math.max(1,e.nodes.length)*2*Math.PI;d=i/2+Math.cos(g)*180+(Math.random()-.5)*60,h=t/2+Math.sin(g)*180+(Math.random()-.5)*60}else{let g=Math.random()*2*Math.PI,b=80+Math.random()*90;d=i/2+Math.cos(g)*b+(Math.random()-.5)*100,h=t/2+Math.sin(g)*b+(Math.random()-.5)*100}let m={...r,x:d,y:h,vx:l?l.vx:(Math.random()-.5)*2,vy:l?l.vy:(Math.random()-.5)*2,radius:c};return this.nodeMap.set(r.id,m),m}),this.links=e.links.map(r=>({...r,sourceNode:this.nodeMap.get(typeof r.source=="string"?r.source:r.source.id),targetNode:this.nodeMap.get(typeof r.target=="string"?r.target:r.target.id)})),this.alpha=1,this.startSimulation()}resize(){let e=this.container.getBoundingClientRect(),i=window.devicePixelRatio||1,t=e.width||800,s=e.height||600;this.canvas.width=t*i,this.canvas.height=s*i,this.canvas.style.width=`${t}px`,this.canvas.style.height=`${s}px`,this.ctx.scale(i,i),this.offsetX===0&&this.offsetY===0&&(this.offsetX=t/2,this.offsetY=s/2)}startSimulation(){this.animationFrameId!==null&&cancelAnimationFrame(this.animationFrameId);let e=()=>{this.targetScale!==null&&this.targetOffsetX!==null&&this.targetOffsetY!==null&&(this.scale+=(this.targetScale-this.scale)*.12,this.offsetX+=(this.targetOffsetX-this.offsetX)*.12,this.offsetY+=(this.targetOffsetY-this.offsetY)*.12,Math.abs(this.scale-this.targetScale)<.005&&Math.abs(this.offsetX-this.targetOffsetX)<.5&&Math.abs(this.offsetY-this.targetOffsetY)<.5&&(this.scale=this.targetScale,this.offsetX=this.targetOffsetX,this.offsetY=this.targetOffsetY,this.targetScale=null,this.targetOffsetX=null,this.targetOffsetY=null)),this.isSimulationRunning&&this.tick(),this.render(),this.animationFrameId=requestAnimationFrame(e)};this.animationFrameId=requestAnimationFrame(e)}tick(){if(this.alpha<this.alphaMin)return;let e=this.canvas.width/(window.devicePixelRatio||1),i=this.canvas.height/(window.devicePixelRatio||1),t=e/2,s=i/2,n=this.config.gravity*this.alpha;for(let r of this.nodes)r.vx+=(t-r.x)*n,r.vy+=(s-r.y)*n;let a=this.config.repulsion*this.alpha;for(let r=0;r<this.nodes.length;r++){let o=this.nodes[r];for(let l=r+1;l<this.nodes.length;l++){let c=this.nodes[l],d=c.x-o.x,h=c.y-o.y,m=d*d+h*h;m===0&&(m=1);let g=Math.sqrt(m),b=(o.radius+c.radius)*this.config.nodeSizeMultiplier+36,p=o.type==="book"||c.type==="book"?3.5:1.4,f=a/m*p,v=d/g*f,y=h/g*f;if(o.isDragging||(o.vx-=v,o.vy-=y),c.isDragging||(c.vx+=v,c.vy+=y),g<b){let w=(b-g)*.7*this.alpha,S=d/g*w,E=h/g*w;o.isDragging||(o.x-=S,o.y-=E),c.isDragging||(c.x+=S,c.y+=E)}}}for(let r of this.links){if(!r.sourceNode||!r.targetNode)continue;let o=r.sourceNode,l=r.targetNode,c=l.x-o.x,d=l.y-o.y,h=Math.sqrt(c*c+d*d)||1,m=r.type==="contains"?this.config.linkDistance:this.config.linkDistance*1.6,g=(r.strength||.5)*this.config.linkStrength*this.alpha,b=(h-m)*g,p=c/h*b,f=d/h*b;o.isDragging||(o.vx+=p,o.vy+=f),l.isDragging||(l.vx-=p,l.vy-=f)}for(let r of this.nodes)r.isDragging||(r.vx*=this.config.damping,r.vy*=this.config.damping,r.x+=r.vx,r.y+=r.vy);this.alpha*=1-this.alphaDecay}render(){let e=window.devicePixelRatio||1,i=this.canvas.width/e,t=this.canvas.height/e;if(this.ctx.clearRect(0,0,i,t),this.ctx.fillStyle="#0a0d14",this.ctx.fillRect(0,0,i,t),this.config.showParticles){this.ctx.save();for(let n of this.starfieldGrid){let a=((n.x*this.scale+this.offsetX)%i+i)%i,r=((n.y*this.scale+this.offsetY)%t+t)%t;this.ctx.beginPath(),this.ctx.arc(a,r,n.size,0,Math.PI*2),this.ctx.fillStyle=`rgba(168, 185, 247, ${n.opacity*Math.min(1,this.scale)})`,this.ctx.fill()}this.ctx.restore()}this.ctx.save(),this.ctx.translate(this.offsetX,this.offsetY),this.ctx.scale(this.scale,this.scale),this.ctx.translate(-i/2,-t/2);let s=this.hoveredNode||this.selectedNode;for(let n of this.links){if(!n.sourceNode||!n.targetNode)continue;let a=n.sourceNode,r=n.targetNode,o=s&&(a.id===s.id||r.id===s.id);if(this.ctx.beginPath(),this.ctx.moveTo(a.x,a.y),this.ctx.lineTo(r.x,r.y),o)this.ctx.strokeStyle="rgba(168, 85, 247, 0.85)",this.ctx.lineWidth=(n.type==="contains"?2.5:1.8)/Math.sqrt(this.scale);else{let l=s!==null;this.ctx.strokeStyle=l?"rgba(255, 255, 255, 0.03)":n.type==="contains"?"rgba(255, 255, 255, 0.12)":"rgba(56, 189, 248, 0.18)",this.ctx.lineWidth=(n.type==="contains"?1.2:.8)/Math.sqrt(this.scale)}this.ctx.stroke()}for(let n of this.nodes){let a=this.hoveredNode?.id===n.id,r=this.selectedNode?.id===n.id,o=s?this.areNodesConnected(n,s):!1,l=s!==null&&!a&&!r&&!o,c=n.x,d=n.y,h=n.radius*this.config.nodeSizeMultiplier;this.ctx.save(),this.ctx.globalAlpha=l?.2:1;let m="#6366f1",g="rgba(99, 102, 241, 0.25)";n.type==="book"?(m="#a855f7",g="rgba(168, 85, 247, 0.35)"):n.type==="topic"?(m="#06b6d4",g="rgba(6, 182, 212, 0.3)"):n.color==="yellow"?(m="#f59e0b",g="rgba(245, 158, 11, 0.25)"):n.color==="blue"?(m="#38bdf8",g="rgba(56, 189, 248, 0.25)"):n.color==="pink"?(m="#f43f5e",g="rgba(244, 63, 94, 0.25)"):n.color==="orange"&&(m="#fb923c",g="rgba(251, 146, 60, 0.25)");let b=(a||r?h*2.4:h*1.6)/Math.sqrt(this.scale),p=this.ctx.createRadialGradient(c,d,h*.5,c,d,b);if(p.addColorStop(0,g),p.addColorStop(1,"rgba(0, 0, 0, 0)"),this.ctx.fillStyle=p,this.ctx.beginPath(),this.ctx.arc(c,d,b,0,Math.PI*2),this.ctx.fill(),n.type==="book"&&(this.ctx.beginPath(),this.ctx.arc(c,d,h+5/Math.sqrt(this.scale),0,Math.PI*2),this.ctx.strokeStyle=a||r?"#ffffff":"rgba(168, 85, 247, 0.6)",this.ctx.lineWidth=2/Math.sqrt(this.scale),this.ctx.stroke()),this.ctx.beginPath(),this.ctx.arc(c,d,h,0,Math.PI*2),this.ctx.fillStyle=m,this.ctx.fill(),this.ctx.strokeStyle=a||r?"#ffffff":"rgba(255, 255, 255, 0.35)",this.ctx.lineWidth=(a?2.5:1.2)/Math.sqrt(this.scale),this.ctx.stroke(),this.config.showLabels&&(n.type==="book"||n.type==="topic"||a||r||o||this.scale>1.8)){let v=n.type==="book"?13:n.type==="topic"?11.5:10;this.ctx.font=`${n.type==="book"?"700":"600"} ${v/Math.sqrt(this.scale)}px Inter, sans-serif`,this.ctx.textAlign="center",this.ctx.textBaseline="top";let y=n.label;n.type==="highlight"&&y.length>24&&(y=y.substring(0,22)+"...");let w=d+h+4/Math.sqrt(this.scale);this.ctx.fillStyle="rgba(10, 13, 20, 0.85)";let S=this.ctx.measureText(y),E=5/Math.sqrt(this.scale),G=2.5/Math.sqrt(this.scale),j=v/Math.sqrt(this.scale);this.ctx.fillRect(c-S.width/2-E,w-G,S.width+E*2,j+G*2),this.ctx.fillStyle=a||r?"#ffffff":n.type==="book"?"#f1f5f9":n.type==="topic"?"#67e8f9":"rgba(255, 255, 255, 0.85)",this.ctx.fillText(y,c,w)}this.ctx.restore()}this.ctx.restore()}areNodesConnected(e,i){return this.links.some(t=>t.sourceNode?.id===e.id&&t.targetNode?.id===i.id||t.sourceNode?.id===i.id&&t.targetNode?.id===e.id)}getNodeAtPosition(e,i){let t=this.canvas.width/(window.devicePixelRatio||1),s=this.canvas.height/(window.devicePixelRatio||1),n=(e-this.offsetX)/this.scale+t/2,a=(i-this.offsetY)/this.scale+s/2;for(let r=this.nodes.length-1;r>=0;r--){let o=this.nodes[r],l=n-o.x,c=a-o.y,d=o.radius*this.config.nodeSizeMultiplier+6;if(l*l+c*c<=d*d)return o}return null}flyToNode(e,i=1.8){let t=this.canvas.width/(window.devicePixelRatio||1),s=this.canvas.height/(window.devicePixelRatio||1);this.targetScale=i,this.targetOffsetX=t/2-(e.x-t/2)*i,this.targetOffsetY=s/2-(e.y-s/2)*i,this.selectedNode=e}createObsidianHUD(){this.hudElement=document.createElement("div"),this.hudElement.className="obsidian-graph-hud",this.hudElement.innerHTML=`
    ...
    `,this.container.appendChild(this.hudElement);let e=this.hudElement.querySelector("#btn-toggle-hud"),i=this.hudElement.querySelector(".hud-body");e?.addEventListener("click",()=>{i&&(i.style.display=i.style.display==="none"?"flex":"none",e.textContent=i.style.display==="none"?"+":"\u2014")});let t=this.hudElement.querySelector("#slider-repulsion");t?.addEventListener("input",()=>{this.config.repulsion=Number(t.value);let l=this.hudElement?.querySelector("#val-repulsion");l&&(l.textContent=t.value),this.alpha=Math.max(this.alpha,.4)});let s=this.hudElement.querySelector("#slider-distance");s?.addEventListener("input",()=>{this.config.linkDistance=Number(s.value);let l=this.hudElement?.querySelector("#val-distance");l&&(l.textContent=s.value),this.alpha=Math.max(this.alpha,.4)});let n=this.hudElement.querySelector("#slider-gravity");n?.addEventListener("input",()=>{this.config.gravity=Number(n.value)/1e3;let l=this.hudElement?.querySelector("#val-gravity");l&&(l.textContent=n.value),this.alpha=Math.max(this.alpha,.4)});let a=this.hudElement.querySelector("#chk-labels");a?.addEventListener("change",()=>{this.config.showLabels=a.checked});let r=this.hudElement.querySelector("#chk-particles");r?.addEventListener("change",()=>{this.config.showParticles=r.checked}),this.hudElement.querySelector("#btn-reset-camera")?.addEventListener("click",()=>this.resetView());let o=this.hudElement.querySelector("#btn-toggle-sim");o?.addEventListener("click",()=>{let l=this.togglePhysics();o&&(o.textContent=l?"Freeze":"Unfreeze")})}initEvents(){window.addEventListener("resize",()=>this.resize()),this.canvas.addEventListener("mousemove",t=>{let s=this.canvas.getBoundingClientRect(),n=t.clientX-s.left,a=t.clientY-s.top;if(this.draggedNode){let o=this.canvas.width/(window.devicePixelRatio||1),l=this.canvas.height/(window.devicePixelRatio||1);this.draggedNode.x=(n-this.offsetX)/this.scale+o/2,this.draggedNode.y=(a-this.offsetY)/this.scale+l/2,this.alpha=Math.max(this.alpha,.4);return}if(this.isPanning){this.offsetX+=n-this.panStartX,this.offsetY+=a-this.panStartY,this.panStartX=n,this.panStartY=a;return}let r=this.getNodeAtPosition(n,a);this.hoveredNode=r,this.canvas.style.cursor=r?"pointer":"grab"}),this.canvas.addEventListener("mousedown",t=>{let s=this.canvas.getBoundingClientRect(),n=t.clientX-s.left,a=t.clientY-s.top,r=this.getNodeAtPosition(n,a);r?(this.draggedNode=r,r.isDragging=!0,this.alpha=.6):(this.isPanning=!0,this.panStartX=n,this.panStartY=a,this.canvas.style.cursor="grabbing")}),window.addEventListener("mouseup",t=>{this.draggedNode&&(this.draggedNode.isDragging=!1,this.draggedNode=null),this.isPanning=!1,this.canvas.style.cursor=this.hoveredNode?"pointer":"grab"}),this.canvas.addEventListener("click",t=>{let s=this.canvas.getBoundingClientRect(),n=t.clientX-s.left,a=t.clientY-s.top,r=this.getNodeAtPosition(n,a);r?(this.flyToNode(r),this.onNodeClickCallback&&this.onNodeClickCallback(r)):this.selectedNode=null}),this.canvas.addEventListener("wheel",t=>{t.preventDefault();let s=this.canvas.getBoundingClientRect(),n=t.clientX-s.left,a=t.clientY-s.top,r=t.deltaY<0?1.14:.86,o=Math.max(this.minScale,Math.min(this.maxScale,this.scale*r));this.offsetX=n-(n-this.offsetX)*(o/this.scale),this.offsetY=a-(a-this.offsetY)*(o/this.scale),this.scale=o},{passive:!1});let e=null,i=1;this.canvas.addEventListener("touchstart",t=>{if(t.touches.length===1){let s=t.touches[0],n=this.canvas.getBoundingClientRect(),a=s.clientX-n.left,r=s.clientY-n.top,o=this.getNodeAtPosition(a,r);o?(this.draggedNode=o,o.isDragging=!0,this.alpha=.6):(this.isPanning=!0,this.panStartX=a,this.panStartY=r)}else if(t.touches.length===2){let s=t.touches[0],n=t.touches[1];e=Math.hypot(n.clientX-s.clientX,n.clientY-s.clientY),i=this.scale}},{passive:!0}),this.canvas.addEventListener("touchmove",t=>{if(t.touches.length===1){let s=t.touches[0],n=this.canvas.getBoundingClientRect(),a=s.clientX-n.left,r=s.clientY-n.top;if(this.draggedNode){let o=this.canvas.width/(window.devicePixelRatio||1),l=this.canvas.height/(window.devicePixelRatio||1);this.draggedNode.x=(a-this.offsetX)/this.scale+o/2,this.draggedNode.y=(r-this.offsetY)/this.scale+l/2,this.alpha=Math.max(this.alpha,.4);return}this.isPanning&&(this.offsetX+=a-this.panStartX,this.offsetY+=r-this.panStartY,this.panStartX=a,this.panStartY=r)}else if(t.touches.length===2&&e!==null){let s=t.touches[0],n=t.touches[1],r=Math.hypot(n.clientX-s.clientX,n.clientY-s.clientY)/e;this.scale=Math.max(this.minScale,Math.min(this.maxScale,i*r))}},{passive:!0}),this.canvas.addEventListener("touchend",()=>{this.draggedNode&&(this.draggedNode.isDragging=!1,this.draggedNode=null),this.isPanning=!1,e=null})}zoomIn(){this.scale=Math.min(this.maxScale,this.scale*1.25)}zoomOut(){this.scale=Math.max(this.minScale,this.scale*.8)}resetView(){let e=this.container.getBoundingClientRect();this.scale=1,this.targetScale=null,this.targetOffsetX=null,this.targetOffsetY=null,this.offsetX=(e.width||800)/2,this.offsetY=(e.height||600)/2,this.selectedNode=null,this.alpha=1}togglePhysics(){return this.isSimulationRunning=!this.isSimulationRunning,this.isSimulationRunning&&(this.alpha=.5),this.isSimulationRunning}};var M=class{container;currentTab="highlights";onSelectHighlight;onSelectBook;onUpdateBookStatus;onOpenQuoteCard;constructor(e,i){this.container=e,this.onSelectHighlight=i?.onSelectHighlight,this.onSelectBook=i?.onSelectBook,this.onUpdateBookStatus=i?.onUpdateBookStatus,this.onOpenQuoteCard=i?.onOpenQuoteCard}render(e,i){this.container.innerHTML="";let t=document.createElement("div");t.className="cards-nav-header";let s=document.createElement("div");s.className="cards-subtabs",[{id:"highlights",label:`Highlights (${i.length})`,icon:"\u{1F4AC}"},{id:"books",label:`Book Shelf (${e.length})`,icon:"\u{1F4DA}"},{id:"kanban",label:"Reading OS Kanban",icon:"\u{1F4CA}"}].forEach(r=>{let o=document.createElement("button");o.className=`subtab-btn ${this.currentTab===r.id?"active":""}`,o.setAttribute("data-subtab",r.id),o.innerHTML=`<span>${r.icon}</span> <span>${r.label}</span>`,o.addEventListener("click",()=>{this.currentTab=r.id,this.render(e,i)}),s.appendChild(o)}),t.appendChild(s),this.container.appendChild(t);let a=document.createElement("div");a.className="cards-content-body",this.currentTab==="highlights"?a.appendChild(this.createHighlightsGrid(i)):this.currentTab==="books"?a.appendChild(this.createBooksGrid(e)):this.currentTab==="kanban"&&a.appendChild(this.createKanbanBoard(e)),this.container.appendChild(a)}createHighlightsGrid(e){let i=document.createElement("div");if(i.className="highlights-masonry-grid",e.length===0){let t=document.createElement("div");return t.className="empty-state-editorial",t.innerHTML=`
      ...
      `;let a=s.querySelector(".btn-copy-quote");a?.addEventListener("click",o=>{o.stopPropagation();let l=`> "${t.rawText}"
> \u2014 **${t.bookTitle}** (Loc ${t.location||"N/A"})`;navigator.clipboard?.writeText(l),a.innerHTML='<span style="color:#10b981;font-size:11px;font-weight:700;">\u2713</span>',setTimeout(()=>{a.innerHTML='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>'},1500)}),s.querySelector(".btn-artboard-quote")?.addEventListener("click",o=>{o.stopPropagation(),this.onOpenQuoteCard?this.onOpenQuoteCard(t):this.onSelectHighlight&&this.onSelectHighlight(t)}),s.addEventListener("click",()=>{this.onSelectHighlight&&this.onSelectHighlight(t)}),i.appendChild(s)}),i}createBooksGrid(e){let i=document.createElement("div");return i.className="books-shelf-grid",e.forEach(t=>{let s=document.createElement("article");s.className="book-shelf-card",s.innerHTML=`
      ...
      `,s.addEventListener("click",()=>{this.onSelectBook&&this.onSelectBook(t.id)}),i.appendChild(s)}),i}createKanbanBoard(e){let i=document.createElement("div");return i.className="kanban-board-container",[{id:"reading",title:"Currently Reading",emoji:"\u{1F4D6}"},{id:"completed",title:"Completed & Processed",emoji:"\u2705"},{id:"want_to_read",title:"Want to Read",emoji:"\u{1F516}"}].forEach(s=>{let n=e.filter(l=>(l.status||"reading")===s.id),a=document.createElement("div");a.className="kanban-column";let r=document.createElement("div");r.className="kanban-col-header",r.innerHTML=`
        <span class="kanban-col-title">${s.emoji} ${s.title}</span>
        <span class="kanban-col-count">${n.length}</span>
      `,a.appendChild(r);let o=document.createElement("div");o.className="kanban-cards-stack",o.setAttribute("data-status",s.id),n.forEach(l=>{let c=document.createElement("div");c.className="kanban-book-item",c.innerHTML=`
        ...
        `;let d=c.querySelector(".kanban-status-select");d&&(d.addEventListener("click",h=>h.stopPropagation()),d.addEventListener("change",()=>{let h=d.value;this.onUpdateBookStatus&&this.onUpdateBookStatus(l.id,h)})),c.addEventListener("click",()=>{this.onSelectBook&&this.onSelectBook(l.id)}),o.appendChild(c)}),a.appendChild(o),i.appendChild(a)}),i}escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}};var $=class{container;currentHighlight=null;currentTheme="obsidian";currentRatio="1:1";fontStyle="serif";textAlign="left";fontSize=44;canvas;ctx;constructor(){this.container=document.createElement("div"),this.container.className="quote-modal-backdrop",this.container.style.display="none",document.body.appendChild(this.container),this.canvas=document.createElement("canvas");let e=this.canvas.getContext("2d");if(!e)throw new Error("Could not get 2D context for quote card.");this.ctx=e,this.initDOM()}initDOM(){this.container.innerHTML=`
    ...
    `,this.panel.querySelector("#btn-close-slideover")?.addEventListener("click",()=>this.close()),this.panel.querySelector("#btn-open-quote-card")?.addEventListener("click",()=>{this.currentHighlight&&this.quoteModal.open(this.currentHighlight)});let t="obsidian",s=this.panel.querySelector("#citation-text-content"),n=this.panel.querySelectorAll(".btn-cite-format");n.forEach(c=>{c.addEventListener("click",()=>{n.forEach(d=>d.classList.remove("active")),c.classList.add("active"),t=c.getAttribute("data-fmt")||"obsidian",s&&(s.textContent=this.generateCitation(e,t))})});let a=this.panel.querySelector("#btn-copy-active-citation");a?.addEventListener("click",async()=>{let c=s?.textContent||"";navigator.clipboard&&(await navigator.clipboard.writeText(c),a&&(a.textContent="Copied!",a.style.color="#10b981",setTimeout(()=>{a.textContent="Copy",a.style.color=""},1800)))});let r=this.panel.querySelector("#drawer-reflection-input"),o=this.panel.querySelector("#save-status-indicator"),l=null;r?.addEventListener("input",()=>{o&&(o.textContent="Saving..."),clearTimeout(l),l=setTimeout(()=>{this.currentHighlight&&(this.currentHighlight.interpretation=r.value,this.store.updateHighlightInterpretation(this.currentHighlight.id,r.value),o&&(o.textContent="Saved"))},500)})}generateCitation(e,i){let t=e.location?`Loc ${e.location}`:"Personal Note";switch(i){case"obsidian":return`> "${e.rawText}"
...
${JSON.stringify(e.map(o=>({book:o.bookTitle,text:o.rawText})))}`,a=await(await fetch(t.endpoint||"https://api.openai.com/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t.apiKey}`},body:JSON.stringify({model:t.modelName||"gpt-4o-mini",messages:[{role:"user",content:s}],response_format:{type:"json_object"}})})).json();return{...JSON.parse(a.choices[0].message.content),sourceHighlightsCount:e.length}}};var q=class{container;store;activeTask="synthesis";constructor(){this.store=k.getInstance(),this.container=document.createElement("div"),this.container.className="ai-modal-backdrop",this.container.style.display="none",document.body.appendChild(this.container),this.initDOM()}initDOM(){this.container.innerHTML=`
    ...
    `;let i=this.store.getFilteredHighlights(),t=this.store.getState().books;if(this.activeTask==="synthesis"){let s=await C.generateExecutiveSynthesis(i);this.renderSynthesis(e,s)}else if(this.activeTask==="clusters"){let s=await C.extractConceptClusters(i,t);this.renderClusters(e,s)}else if(this.activeTask==="questions"){let s=await C.generateSocraticQuestions(i);this.renderQuestions(e,s)}}renderSynthesis(e,i){e.innerHTML=`
    ...
    `}copyMarkdown(){let i=this.container.querySelector("#ai-results-stage")?.innerText||"";if(navigator.clipboard){navigator.clipboard.writeText(i);let t=this.container.querySelector("#btn-copy-ai-result span");t&&(t.textContent="Copied to Clipboard!",setTimeout(()=>{t.textContent="Copy Markdown Synthesis"},2e3))}}};var R=class u{files=[];addFile(e,i){return this.files.push({name:e.replace(/\\/g,"/"),content:i}),this}generateBlob(){let e=[],i=[],t=0,s=new TextEncoder;for(let c of this.files){let d=s.encode(c.name),h=typeof c.content=="string"?s.encode(c.content):c.content,m=u.crc32(h),g=h.length,b=new Uint8Array(30+d.length),p=new DataView(b.buffer);p.setUint32(0,67324752,!0),p.setUint16(4,20,!0),p.setUint16(6,0,!0),p.setUint16(8,0,!0),p.setUint16(10,0,!0),p.setUint16(12,0,!0),p.setUint32(14,m,!0),p.setUint32(18,g,!0),p.setUint32(22,g,!0),p.setUint16(26,d.length,!0),p.setUint16(28,0,!0),b.set(d,30),e.push(b,h);let f=new Uint8Array(46+d.length),v=new DataView(f.buffer);v.setUint32(0,33639248,!0),v.setUint16(4,20,!0),v.setUint16(6,20,!0),v.setUint16(8,0,!0),v.setUint16(10,0,!0),v.setUint16(12,0,!0),v.setUint16(14,0,!0),v.setUint32(16,m,!0),v.setUint32(20,g,!0),v.setUint32(24,g,!0),v.setUint16(28,d.length,!0),v.setUint16(30,0,!0),v.setUint16(32,0,!0),v.setUint16(34,0,!0),v.setUint16(36,0,!0),v.setUint32(38,0,!0),v.setUint32(42,t,!0),f.set(d,46),i.push(f),t+=b.length+h.length}let n=t,a=0;for(let c of i)a+=c.length;let r=new Uint8Array(22),o=new DataView(r.buffer);o.setUint32(0,101010256,!0),o.setUint16(4,0,!0),o.setUint16(6,0,!0),o.setUint16(8,this.files.length,!0),o.setUint16(10,this.files.length,!0),o.setUint32(12,a,!0),o.setUint32(16,n,!0),o.setUint16(20,0,!0);let l=[...e,...i,r];return new Blob(l,{type:"application/zip"})}downloadZip(e="hakim-obsidian-vault.zip"){let i=this.generateBlob(),t=URL.createObjectURL(i),s=document.createElement("a");s.href=t,s.download=e,document.body.appendChild(s),s.click(),document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(t),1e3)}static crcTable=(()=>{let e=new Uint32Array(256);for(let i=0;i<256;i++){let t=i;for(let s=0;s<8;s++)t=t&1?3988292384^t>>>1:t>>>1;e[i]=t}return e})();static crc32(e){let i=-1;for(let t=0;t<e.length;t++)i=i>>>8^u.crcTable[(i^e[t])&255];return(i^-1)>>>0}};var P=class u{static generateVault(e,i){let t=[],s=new R,n=u.formatIndexNote(e,i);t.push({path:"Index.md",content:n}),s.addFile("Index.md",n);for(let o of e){let l=i.filter(m=>m.bookId===o.id||m.bookTitle===o.title),c=u.sanitizeFileName(o.title),d=u.formatBookNote(o,l),h=`Books/${c}.md`;t.push({path:h,content:d}),s.addFile(h,d)}let a=new Map;for(let o of i)for(let l of o.tags||[]){let c=l.trim();c&&(a.has(c)||a.set(c,[]),a.get(c).push(o))}let r=0;return a.forEach((o,l)=>{r++;let c=u.sanitizeFileName(l),d=u.formatConceptNote(l,o),h=`Concepts/${c}.md`;t.push({path:h,content:d}),s.addFile(h,d)}),{files:t,booksCount:e.length,highlightsCount:i.length,conceptsCount:r,zipBuilder:s}}static formatBookNote(e,i){let t=[];if(t.push("---"),t.push(`title: ${JSON.stringify(e.title)}`),t.push(`author: ${JSON.stringify(e.author)}`),e.asin&&t.push(`asin: ${JSON.stringify(e.asin)}`),t.push(`status: ${e.status||"reading"}`),t.push(`highlights_count: ${i.length}`),t.push("tags:"),t.push("  - type/book"),t.push("  - reading-intelligence"),t.push("---"),t.push(""),t.push(`# ${e.title}`),t.push(`**Author:** [[${e.author}]]`),t.push(`**Status:** \`${(e.status||"reading").toUpperCase()}\``),t.push(`**Total Highlights:** ${i.length}`),t.push(""),t.push("---"),t.push(""),t.push("## \u{1F4D6} Highlights & Annotations"),t.push(""),i.length===0)return t.push("*No highlights captured for this book yet.*"),t.join(`
`);let s=[...i].sort((n,a)=>(n.location||0)-(a.location||0));for(let n=0;n<s.length;n++){let a=s[n],r=a.color==="pink"?"danger":a.color==="blue"?"info":a.color==="orange"?"warning":"quote";a.chapter&&(t.push(`### ${a.chapter}`),t.push("")),t.push(`> [!${r}] Highlight #${n+1}`),t.push(`> ${a.rawText}`);let o=[];a.location&&o.push(`Loc ${a.location}`),a.color&&o.push(`Color: ${a.color}`),a.importance&&o.push(`Importance: ${a.importance}`),o.length>0&&(t.push(">"),t.push(`> \u2014 *${o.join(" \u2022 ")}*`)),a.sourceNote&&(t.push(""),t.push("> [!note] Personal Note"),t.push(`> ${a.sourceNote}`)),a.interpretation&&(t.push(""),t.push(`**\u{1F4A1} Reflection:** ${a.interpretation}`)),a.tags&&a.tags.length>0&&(t.push(""),t.push(`**Concepts:** ${a.tags.map(l=>`[[Concepts/${l}|#${l}]]`).join(" ")}`)),t.push(`^hl-${a.id}`),t.push(""),t.push("---"),t.push("")}return t.join(`
...
`)}static sanitizeFileName(e){return e.replace(/[\\/:*?"<>|]/g,"_").trim()}};var D=class{container;store;currentResult=null;selectedFilePath="Index.md";constructor(){this.store=k.getInstance(),this.container=document.createElement("div"),this.container.className="obsidian-modal-backdrop",this.container.style.display="none",document.body.appendChild(this.container),this.initDOM()}initDOM(){this.container.innerHTML=`
    ...
    `,this.input=this.container.querySelector(".cmd-input"),this.resultsList=this.container.querySelector(".cmd-results-list"),this.initEvents()}initEvents(){this.container.addEventListener("click",e=>{e.target===this.container&&this.close()}),this.input.addEventListener("input",()=>{this.filterItems(this.input.value)}),this.input.addEventListener("keydown",e=>{e.key==="ArrowDown"?(e.preventDefault(),this.selectedIndex=Math.min(this.selectedIndex+1,this.filteredItems.length-1),this.renderResults()):e.key==="ArrowUp"?(e.preventDefault(),this.selectedIndex=Math.max(this.selectedIndex-1,0),this.renderResults()):e.key==="Enter"?(e.preventDefault(),this.filteredItems[this.selectedIndex]&&this.executeItem(this.filteredItems[this.selectedIndex])):e.key==="Escape"&&this.close()}),window.addEventListener("keydown",e=>{(e.metaKey||e.ctrlKey)&&(e.key==="k"||e.key==="K")&&(e.preventDefault(),this.toggle())})}open(){this.isOpen=!0,this.container.style.display="flex",this.buildItems(),this.input.value="",this.filterItems(""),setTimeout(()=>this.input.focus(),50)}close(){this.isOpen=!1,this.container.style.display="none"}toggle(){this.isOpen?this.close():this.open()}buildItems(){let e=this.store.getState(),i=[];i.push({id:"view-graph",title:"Switch to Knowledge Graph View",subtitle:"2D Force-directed Obsidian canvas graph",category:"Views",icon:"\u{1F310}",action:()=>this.onSelectViewCallback?.("graph")}),i.push({id:"view-cards",title:"Switch to Reading Cards & Shelf",subtitle:"Editorial cards grid and 3-column Kanban",category:"Views",icon:"\u{1F4D1}",action:()=>this.onSelectViewCallback?.("cards")}),i.push({id:"view-recall",title:"Switch to 3D Active Recall Deck",subtitle:"Spaced repetition flashcards review",category:"Views",icon:"\u{1F3AF}",action:()=>this.onSelectViewCallback?.("flashcards")}),i.push({id:"act-ai",title:"Launch AI Reading Intelligence",subtitle:"Executive synthesis, concept clusters & questions",category:"Actions",icon:"\u2728",action:()=>this.onOpenAiCallback?.()}),i.push({id:"act-obsidian",title:"Export Obsidian Markdown Vault (.zip)",subtitle:"Download complete vault with reciprocal wikilinks",category:"Actions",icon:"\u{1F48E}",action:()=>this.onOpenObsidianCallback?.()}),i.push({id:"act-engine",title:"Connect Local SQLite Engine (127.0.0.1:4242)",subtitle:"Sync with local offline daemon and database",category:"Actions",icon:"\u26A1",action:()=>this.onOpenEngineCallback?.()});for(let t of e.books)i.push({id:`book-${t.id}`,title:t.title,subtitle:`by ${t.author} \u2022 ${t.highlightsCount} highlights`,category:"Books",icon:"\u{1F4D6}",action:()=>{this.store.selectBook(t.id),this.onSelectViewCallback?.("cards")}});for(let t of e.highlights.slice(0,30))i.push({id:`hl-${t.id}`,title:t.rawText.length>80?t.rawText.substring(0,77)+"...":t.rawText,subtitle:`From ${t.bookTitle} (Loc ${t.location||"N/A"})`,category:"Highlights",icon:"\u{1F4AC}",action:()=>{this.store.selectHighlight(t)}});this.items=i}filterItems(e){let i=e.toLowerCase().trim();i?this.filteredItems=this.items.filter(t=>t.title.toLowerCase().includes(i)||t.subtitle&&t.subtitle.toLowerCase().includes(i)):this.filteredItems=this.items,this.selectedIndex=0,this.renderResults()}renderResults(){if(this.filteredItems.length===0){this.resultsList.innerHTML='<div class="cmd-empty-state">No matching commands, books, or highlights found.</div>';return}let e="",i="";this.filteredItems.forEach((s,n)=>{s.category!==i&&(i=s.category,e+=`<div class="cmd-category-header">${i}</div>`);let a=n===this.selectedIndex;e+=`
        <div class="cmd-item ${a?"selected":""}" data-index="${n}" role="option" aria-selected="${a}">
          ...
          ${a?'<span class="cmd-item-enter">\u21B5</span>':""}
        </div>
      `}),this.resultsList.innerHTML=e,this.resultsList.querySelectorAll(".cmd-item").forEach(s=>{s.addEventListener("click",()=>{let n=Number(s.getAttribute("data-index"));this.filteredItems[n]&&this.executeItem(this.filteredItems[n])})});let t=this.resultsList.querySelector(".cmd-item.selected");t&&t.scrollIntoView({block:"nearest"})}executeItem(e){this.close(),e.action()}escapeHtml(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}};var F=class{store;graphEngine=null;cardsComponent=null;flashcardsComponent=null;slideover=null;engineBridge=null;aiModal=null;obsidianModal=null;commandPalette=null;constructor(){this.store=k.getInstance(),this.init()}init(){let e=document.getElementById("graph-container");e&&(this.graphEngine=new I(e,f=>{this.handleNodeClick(f)}));let i=document.getElementById("cards-container");i&&(this.cardsComponent=new M(i,{onSelectHighlight:f=>this.store.selectHighlight(f),onSelectBook:f=>this.store.selectBook(f),onUpdateBookStatus:(f,v)=>this.store.updateBookStatus(f,v)}));let t=document.getElementById("flashcards-container");t&&(this.flashcardsComponent=new B(t)),this.slideover=new A,this.engineBridge=new N("btn-engine-status"),this.aiModal=new q;let s=document.getElementById("btn-ai-synthesis");s&&s.addEventListener("click",()=>this.aiModal?.open()),this.obsidianModal=new D;let n=document.getElementById("btn-obsidian-export");n&&n.addEventListener("click",()=>this.obsidianModal?.open()),this.commandPalette=new O({onSelectView:f=>this.store.setView(f),onOpenAi:()=>this.aiModal?.open(),onOpenObsidian:()=>this.obsidianModal?.open(),onOpenEngine:()=>this.engineBridge?.open()});let a=document.getElementById("btn-spotlight-trigger");a&&a.addEventListener("click",()=>this.commandPalette?.open()),this.store.subscribe(f=>this.render(f));let r=document.getElementById("search-input");r&&r.addEventListener("input",()=>{this.store.setSearchQuery(r.value)});let o=document.getElementById("dataset-select");o&&o.addEventListener("change",()=>{o.value==="demo"&&this.store.loadDemoData()}),document.querySelectorAll(".view-btn").forEach(f=>{f.addEventListener("click",()=>{let v=f.getAttribute("data-view");v&&this.store.setView(v)})}),document.querySelectorAll(".color-dot-btn").forEach(f=>{f.addEventListener("click",()=>{let v=f.getAttribute("data-color");v&&this.store.toggleColorFilter(v)})});let d=document.getElementById("btn-graph-zoom-in"),h=document.getElementById("btn-graph-zoom-out"),m=document.getElementById("btn-graph-reset"),g=document.getElementById("btn-graph-physics");d&&d.addEventListener("click",()=>this.graphEngine?.zoomIn()),h&&h.addEventListener("click",()=>this.graphEngine?.zoomOut()),m&&m.addEventListener("click",()=>this.graphEngine?.resetView()),g&&g.addEventListener("click",()=>{let f=this.graphEngine?.togglePhysics();g.classList.toggle("active",f)});let b=document.getElementById("file-upload-input"),p=document.getElementById("btn-upload-file");p&&b&&(p.addEventListener("click",()=>b.click()),b.addEventListener("change",async()=>{let f=b.files?.[0];if(!f)return;let v=await f.text();if(f.name.endsWith(".json")){let y=T.parseJsonSnapshot(v);this.store.loadCustomData(y.books,y.highlights,"custom_file")}else{let y=T.parseMyClippings(v);this.store.loadCustomData(y.books,y.highlights,"custom_file")}}))}handleNodeClick(e){if(e.type==="book")this.store.selectBook(e.id===this.store.getState().filters.selectedBookId?null:e.id);else if(e.type==="highlight"){let i=this.store.getState().highlights.find(t=>t.id===e.id);i&&this.store.selectHighlight(i)}}render(e){let i=document.getElementById("graph-container"),t=document.getElementById("cards-container"),s=document.getElementById("flashcards-container"),n=document.querySelector(".graph-toolbar");if(e.selectedHighlight&&this.slideover&&this.slideover.open(e.selectedHighlight),e.activeView==="graph")i&&(i.style.display="block"),t&&(t.style.display="none"),s&&(s.style.display="none"),n&&(n.style.display="flex"),this.graphEngine&&this.graphEngine.setData(e.graphData);else if(e.activeView==="cards"){if(i&&(i.style.display="none"),t&&(t.style.display="block"),s&&(s.style.display="none"),n&&(n.style.display="none"),this.cardsComponent){let h=this.store.getFilteredHighlights();this.cardsComponent.render(e.books,h)}}else if(e.activeView==="flashcards"&&(i&&(i.style.display="none"),t&&(t.style.display="none"),s&&(s.style.display="flex"),n&&(n.style.display="none"),this.flashcardsComponent)){let h=this.store.getFilteredHighlights();this.flashcardsComponent.setDeck(h)}let a=document.getElementById("sidebar-book-list");if(a){a.innerHTML="";let h=document.createElement("button");h.className=`book-item-btn ${e.filters.selectedBookId===null?"active":""}`,h.innerHTML=`<span>All Library Highlights</span> <span class="book-count-badge">${e.highlights.length}</span>`,h.addEventListener("click",()=>this.store.selectBook(null)),a.appendChild(h),e.books.forEach(m=>{let g=document.createElement("button");g.className=`book-item-btn ${e.filters.selectedBookId===m.id?"active":""}`,g.innerHTML=`<span>\u{1F4D6} ${m.title}</span> <span class="book-count-badge">${m.highlightsCount}</span>`,g.addEventListener("click",()=>this.store.selectBook(m.id)),a.appendChild(g)})}document.querySelectorAll(".view-btn").forEach(h=>{h.getAttribute("data-view")===e.activeView?h.classList.add("active"):h.classList.remove("active")}),document.querySelectorAll(".color-dot-btn").forEach(h=>{let m=h.getAttribute("data-color");m&&e.filters.selectedColors.has(m)?h.classList.add("active"):h.classList.remove("active")});let l=document.getElementById("hud-nodes-count"),c=document.getElementById("hud-links-count"),d=document.getElementById("hud-filtered-count");l&&(l.textContent=String(e.graphData.nodes.length)),c&&(c.textContent=String(e.graphData.links.length)),d&&(d.textContent=String(this.store.getFilteredHighlights().length))}};document.addEventListener("DOMContentLoaded",()=>{new F,console.log("\u26A1 Hakim Reading Intelligence Web Client Initialized.")});
